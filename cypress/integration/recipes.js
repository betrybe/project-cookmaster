...
describe("Crie uma tela para visualizar uma receita específica.", () => {
  ...
  it("Quando estou logado verfico se na página da receita existe os botões 'Editar Receita' e 'Excluir Receita'.", () => {
    login('bruno.batista@gmail.com', '12345678');
    clickLinkOrText('Ver Mais');
  ...
  it("Verificar se na página da receita irá exibir o 'título', os 'ingredientes', e a 'forma de preparo' da receita.", () => {
    login('bruno.batista@gmail.com', '12345678');
    clickLinkOrText('Ver Mais');
